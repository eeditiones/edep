...
const copyModules = parallel(epidocEditor, editorStyles, pbStyles, pbImages, pbComponents, pbLib);
 ...
 */
function styles() {
    return src('src/resources/css/*.css').pipe(dest('build/resources/css'));
}
